...
from .views import SkatingCalculatorView,CompetitionListViev,redirect_user,prelims_results,finals_results,register_competitor,submit_results,registration_checkin,submit_self_results
...
urlpatterns = [
    ...
    path('<int:comp_id>/judging/<int:reg_id>/', submit_self_results, name='submit_self_results'),
